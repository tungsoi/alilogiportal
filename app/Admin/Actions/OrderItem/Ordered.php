...
class Ordered extends BatchAction
{
    ...
    {
        return "<a class='ordered btn btn-sm btn-primary' data-toggle='tooltip' title='Xác nhận các sản phẩm được chọn đã đặt hàng'><i class='fa fa-cart-plus'></i> &nbsp; Đã đặt hàng sản phẩm</a>";
    }
